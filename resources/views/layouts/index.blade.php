    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="{{ route('welcome') }}"><img src="{{ asset('assets/images/logoeventosya.png') }}" alt="logo" style="width: 200px; height: auto;"/></a>
          <a class="sidebar-brand brand-logo-mini" href="{{ route('welcome') }}"><img src="{{ asset('assets/images/logoeventosyamini.png') }}" alt="logo"style="width: 50px; height: 30px;" /></a>
        </div>
        <ul class="nav">
          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <ul class="navbar-nav navbar-nav-right">
              <li class="nav-item dropdown d-none d-lg-block">
                <a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false" href="#">+ Crear nuevo evento</a>
